...
class AuditLogManager(models.Manager):
    ...
    def enable_tracking(self):
        if self.instance is None:
            raise ValueError(
                "Tracking can only be enabled or disabled "
...
class AuditLog(object):
            ...
            if not field.name in self._exclude:
                ...
                if field.remote_field and field.remote_field.related_name:
                    field.remote_field.related_name = "_auditlog_{}_{}".format(
                        model._meta.model_name, field.remote_field.related_name
                    )
    ...
    def get_logging_fields(self, model):
        ...
        action_user_field = LastUserField(
            related_name=rel_name, editable=False
        )
        ...
        return {
            ...
            "action_date": models.DateTimeField(
                default=datetime_now, editable=False, blank=False
            ),
